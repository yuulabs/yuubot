...
def test_title_from_user_message_strips_real_time_context() -> None:
    message = augment_user_message(
        InputMessage("user", "amy", text_content("daily report")),
        "actor",
    )
