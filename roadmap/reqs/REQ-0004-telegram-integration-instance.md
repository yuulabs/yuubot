...
# REQ-0004: Telegram Integration Instance

非核心 plumbing。Scenario 契约引用 REQ-0002,本文只记 Telegram 平台差异。
...
- Telegram Bot 注册 / token 申请 = 用户运维任务,非 REQ 范围。
- Telegram channel / group 多端路由策略 = 未来 REQ,不在本 instance。
