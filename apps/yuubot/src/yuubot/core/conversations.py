...
class ConversationManager:
    ...
    async def store_uploads(
        ...
        *,
        ...
        workspace_path, workspace_url_segment = await self._upload_workspace(
            conversation_id=conversation_id,
            binding=binding,
        )
        upload_dir = (
    ...
    async def _upload_workspace(
        ...
        *,
        ...
        capability_set = await self._require_capability_set(actor.capability_set_id)
        workspace_path = self._resolve_workspace_path(capability_set.workspace_path)
